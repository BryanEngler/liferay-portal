...
public class PropsValues {
	...
	public static boolean STAGING_LIVE_GROUP_PORTLET_CONFIGURATION_ENABLED = GetterUtil.getBoolean(PropsUtil.get(PropsKeys.STAGING_LIVE_GROUP_PORTLET_CONFIGURATION_ENABLED));
