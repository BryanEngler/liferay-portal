...
<liferay-ui:error exception="<%= UserPasswordException.MustHaveLDAPExportingEnabled.class %>" message="please-enable-ldap-exporting-to-modify-user-data-through-liferay" />
