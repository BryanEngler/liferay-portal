...
public class ObjectEntryLocalServiceWrapper
	...
	public java.util.List<java.util.Map<String, Object>>
			getObjectEntriesValuesList(
				long objectDefinitionId, int[] statuses, int start, int end)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _objectEntryLocalService.getObjectEntriesValuesList(
	...
	@Override
	public java.util.Map<String, Object> getObjectEntryValues(
			long objectEntryId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _objectEntryLocalService.getObjectEntryValues(objectEntryId);
	}
	...
	public com.liferay.object.model.ObjectEntry updateObjectEntry(
			long objectEntryId, java.util.Map<String, Object> values)
		throws com.liferay.portal.kernel.exception.PortalException {
