...
public class ObjectEntryLocalServiceUtil {
	...
	public static ObjectEntry addObjectEntry(
		...
		return getService().addObjectEntry(
			userId, groupId, objectDefinitionId, values);
	}
	...
	public static List<Map<String, Object>> getObjectEntriesValuesList(
			long objectDefinitionId, int[] statuses, int start, int end)
		throws PortalException {

		return getService().getObjectEntriesValuesList(
	...
	public static Map<String, Object> getObjectEntryValues(long objectEntryId)
		throws PortalException {

		return getService().getObjectEntryValues(objectEntryId);
	}
	...
	public static com.liferay.portal.kernel.search.BaseModelSearchResult
		<ObjectEntry> searchObjectEntries(
				long objectDefinitionId, String keywords,
		...
		return getService().searchObjectEntries(
			objectDefinitionId, keywords, params, cur, delta, orderByField,
			reverse);
	}
	...
	public static ObjectEntry updateObjectEntry(
		...
		return getService().updateObjectEntry(objectEntryId, values);
	}
