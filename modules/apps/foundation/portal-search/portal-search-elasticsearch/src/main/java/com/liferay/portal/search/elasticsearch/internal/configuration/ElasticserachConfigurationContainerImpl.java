 ...
 */
@Component(
	immediate = true, service = {ElasticsearchConfigurationContainer.class}
)
public class ElasticserachConfigurationContainerImpl
	implements ElasticsearchConfigurationContainer {
