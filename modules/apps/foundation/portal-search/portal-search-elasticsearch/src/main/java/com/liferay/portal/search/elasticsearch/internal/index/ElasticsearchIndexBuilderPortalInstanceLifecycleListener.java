...
@Component(
	immediate = true,
	service = {
		PortalInstanceLifecycleListener.class, ElasticsearchIndexBuilder.class
	}
)
public class ElasticsearchIndexBuilderPortalInstanceLifecycleListener
	extends BasePortalInstanceLifecycleListener
	implements ElasticsearchIndexBuilder {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ElasticsearchIndexBuilderPortalInstanceLifecycleListener.class);
