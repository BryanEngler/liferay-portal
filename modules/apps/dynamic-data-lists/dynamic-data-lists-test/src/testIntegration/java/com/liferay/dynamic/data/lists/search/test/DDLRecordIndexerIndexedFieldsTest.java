...
public class DDLRecordIndexerIndexedFieldsTest extends BaseDDLRecordTestCase {
	...
	public void testIndexedFields() throws Exception {
		...
		Map<String, String> expected = _expectedFieldValues(ddlRecord);
	...
	private Map<String, String> _expectedFieldValues(DDLRecord ddlRecord)
		...
		map.put("recordSetScope", String.valueOf(ddlRecordSet.getScope()));
		...
		map.put(
			Field.STAGING_GROUP,
			String.valueOf(ddlRecordFixture.getGroup().isStagingGroup()));
