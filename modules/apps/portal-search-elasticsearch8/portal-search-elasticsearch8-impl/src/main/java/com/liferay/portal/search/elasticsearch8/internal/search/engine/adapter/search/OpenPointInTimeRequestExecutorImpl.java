...
public class OpenPointInTimeRequestExecutorImpl
	...
	public OpenPointInTimeResponse execute(
		...
		co.elastic.clients.elasticsearch.core.OpenPointInTimeResponse
			openPointInTimeResponse = getOpenPointInTimeResponse(
				createOpenPointInTimeRequest(openPointInTimeRequest),
				openPointInTimeRequest);

		return new OpenPointInTimeResponse(openPointInTimeResponse.id());
	}

	protected co.elastic.clients.elasticsearch.core.OpenPointInTimeRequest
	...
	protected co.elastic.clients.elasticsearch.core.OpenPointInTimeResponse
