...
public class CompanyIndexHelper {
	...
	public void createIndex(
		...
		MappingsHelperImpl mappingsHelperImpl = new MappingsHelperImpl(
			indexName, elasticsearchIndicesClient, _jsonFactory,
		...
		try {
			...
			SearchLogHelperUtil.logActionResponse(_log, createIndexResponse);
		}
	...
	public void updateIndex(
		long companyId, String indexName, ElasticsearchIndicesClient elasticsearchIndicesClient) {

		_updateSettings(companyId, indexName, elasticsearchIndicesClient);
