 ...
 * @author Luca Marques
 */
public class BookmarksFolderIndexerFixture {

	public BookmarksFolderIndexerFixture(Indexer<BookmarksFolder> indexer) {
		_indexer = indexer;
	}
	...
	private final Indexer<BookmarksFolder> _indexer;
