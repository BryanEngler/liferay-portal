...
public class DDMTemplateVerifyProcess extends VerifyProcess {
	...
	protected void verifyDuplicateDDMTemplates() throws Exception {
		...
		sb.append(" from DDMTemplate as alpha, ");
		sb.append("DDMTemplate as beta where ");
		...
		try {
			...
			while (rs.next()) {
				...
				verifyDuplicateDDMTemplates(primKey);
			}
		}
		finally {
	...
	protected void verifyDuplicateDDMTemplates(long primKey) throws Exception {
