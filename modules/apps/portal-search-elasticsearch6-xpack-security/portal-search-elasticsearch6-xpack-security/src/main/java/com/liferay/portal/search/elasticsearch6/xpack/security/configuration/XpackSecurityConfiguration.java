...
package com.liferay.portal.search.elasticsearch6.xpack.security.configuration;
...
@Meta.OCD(
	id = "com.liferay.portal.search.elasticsearch6.xpack.security.configuration.XpackSecurityConfiguration",
...
public interface XpackSecurityConfiguration {
	...
	@Meta.AD(description = "password-help", name = "password", required = false)
	...
	@Meta.AD(
		...
		name = "transport-ssl-verification-mode", required = false
	)
