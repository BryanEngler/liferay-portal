 ...
 * @author Luca Marques
 */
public class AssetVocabularyIndexerFixture {

	public AssetVocabularyIndexerFixture(Indexer<AssetVocabulary> indexer) {
		_indexer = indexer;
	}
	...
	private final Indexer<AssetVocabulary> _indexer;
