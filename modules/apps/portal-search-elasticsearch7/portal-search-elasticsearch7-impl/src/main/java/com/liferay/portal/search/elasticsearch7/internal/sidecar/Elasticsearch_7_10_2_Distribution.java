...
public class Elasticsearch_7_10_2_Distribution implements Distribution {
	...
	public Distributable getElasticsearchDistributable() {
		return new DistributableImpl(
			_ELASTICSEARCH_URL, _ELASTICSEARCH_CHECKSUM);
	}

	@Override
	public List<Distributable> getPluginDistributables() {
		return Arrays.asList(
			new DistributableImpl(_ICU_URL, _ICU_CHECKSUM),
			new DistributableImpl(_KUROMOJI_URL, _KUROMOJI_CHECKSUM),
			new DistributableImpl(_SMARTCN_URL, _SMARTCN_CHECKSUM),
			new DistributableImpl(_STEMPEL_URL, _STEMPEL_CHECKSUM));
	}

	private static final String _BASE_URL =
		"https://repository.liferay.com/nexus/service/local/repositories" +
			"/third-party/content/com/liferay/";
	...
	private static final String _ELASTICSEARCH_URL =
		_BASE_URL + "org.elasticsearch.server/7.10.2" +
			"/org.elasticsearch.server-7.10.2.tar.gz";
	...
	private static final String _ICU_URL =
		_BASE_URL + "org.elasticsearch.plugin.analysis.icu/7.10.2" +
			"/org.elasticsearch.plugin.analysis.icu-7.10.2.zip";
	...
	private static final String _KUROMOJI_URL =
		_BASE_URL + "org.elasticsearch.plugin.analysis.kuromoji/7.10.2" +
			"/org.elasticsearch.plugin.analysis.kuromoji-7.10.2.zip";
	...
	private static final String _SMARTCN_URL =
		_BASE_URL + "org.elasticsearch.plugin.analysis.smartcn/7.10.2" +
			"/org.elasticsearch.plugin.analysis.smartcn-7.10.2.zip";
	...
	private static final String _STEMPEL_URL =
		_BASE_URL + "org.elasticsearch.plugin.analysis.stempel/7.10.2" +
			"/org.elasticsearch.plugin.analysis.stempel-7.10.2.zip";
