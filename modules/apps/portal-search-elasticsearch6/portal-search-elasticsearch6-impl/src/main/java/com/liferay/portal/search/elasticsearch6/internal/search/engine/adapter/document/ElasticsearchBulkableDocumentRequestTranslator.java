...
public class ElasticsearchBulkableDocumentRequestTranslator
	...
	public DeleteRequest translate(
		...
		DeleteRequest deleteRequest = new DeleteRequest(
			...
			deleteDocumentRequest.getType(), deleteDocumentRequest.getUid());
	...
	public IndexRequest translate(
		...
		try {
			...
			IndexRequest indexRequest = new IndexRequest(
				indexDocumentRequest.getIndexName(), document.get(Field.TYPE),
				document.getUID());
	...
	public UpdateRequest translate(
		...
		try {
			...
			UpdateRequest updateRequest = new UpdateRequest(
				updateDocumentRequest.getIndexName(), document.get(Field.TYPE),
				document.getUID());
