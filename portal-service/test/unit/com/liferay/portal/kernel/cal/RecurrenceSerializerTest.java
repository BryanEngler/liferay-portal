...
public class RecurrenceSerializerTest extends RecurrenceSerializer {
	...
	public Recurrence setupRecurrence(Calendar calendar, int recurrenceType) {
	...
	public void testDailyRecurrence() throws Exception {
		...
		Recurrence recurrence = setupRecurrence(
		...
		Assert.assertEquals("0 4 3 * * ? *", toCronText(recurrence));
	}
	...
	public void testMonthlyRecurrence() throws Exception {
		...
		Assert.assertEquals("0 4 3 15 * ? *", toCronText(recurrence));
	}
